...
`;i.label``;var Wx=l=>{var m=l,{className:e="",avatar:t=null,showOverlay:o,size:r,onClick:n,loading:a}=m,s=M(m,["className","avatar","showOverlay","size","onClick","loading"]);let[p,u]=useState(!1),c=useCallback(()=>u(!0),[]),g=useCallback(()=>u(!1),[]),f=j4(r);return B.createElement(V4,d({className:l6(e,{visible:p,clickable:!!n}),loading:a,size:f,onClick:n},s),t?o?B.createElement($4,d({size:f},s),B.createElement(V2,{src:t,onError:g,onLoad:c})):B.createElement(V2,{src:t,onError:g,onLoad:c}):null)},J=e=>{let t=E("Avatar");return t?t(e):B.createElement(Wx,d({},e))};var Kx=e=>B.createElement("svg",d({xmlns:"http://www.w3.org/2000/svg",width:"100%",height:"100%",viewBox:"0 0 512 512"},e),B.createElement("path",{d:`M256 8C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256
